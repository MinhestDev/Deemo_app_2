...
# I will use EfficientNetB0 pretrained model. You can try diffirent model.
...
# Add droup to model 
# WWe add dropout to increase accurary by reduce overfitting 
model.add(layers.Dropout(0.3))
# Finally we will add dense layer to as an output
...
# Complie model
# You can use diffirent optimizer and loss function to icrease accuracy
...
# monitor: monitor validatetion mae loss to save model 
...
#save_best_only: False -> It wiill save all model
# save_weights_only: Save only weight.

# create learning rate reducer to reduce lr when accuracy does not imporove
# Correct 
